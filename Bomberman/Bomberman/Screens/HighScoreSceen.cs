...
namespace Bomberman.Screens
{
    class HighScoreSceen : GameScreen
    {
        ...
        protected List<BombermanButton> textBlocks = new List<BombermanButton>();
        protected int index;
        public HighScoreSceen(List<HighScore> scores, int index)
        {
            ...
            foreach(String s in presenter.presentHighScores())
                textBlocks.Add(new BombermanButton(s));
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            foreach (BombermanButton b in textBlocks)
                b.Draw(this);
        ...
        public override void Activate(bool instancePreserved)
        {
            ...
            for(int i = 0 ; i < textBlocks.Count ;++i){
                BombermanButton tb = textBlocks[i];
